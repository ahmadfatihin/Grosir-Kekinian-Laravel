                ...
                <table class="table text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>
                                <img src="{{ url('assets/produk') }}/{{ $pesanan_detail->product->gambar }}" class="img-fluid" width="200">
                            </td>
                            <td>
                                {{ $pesanan_detail->product->nama }}
                            </td>
                            <td>
                                @if($pesanan_detail->variasi)
                                    Varian : {{ $pesanan_detail->varian }} <br>
                                @else 
                                    - 
                                @endif
                            </td>
                            ...
                            <td style="text-align: center">
                                <button class="btn bg-transparent btn-outline-danger">
